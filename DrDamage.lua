...
--HACK - in classic all classes have 3 specs
local GetNumSpecializations = function ()
		return 3
end

local GetSpecializationInfo = GetTalentTabInfo -- Classic hack
-- in retail
-- id, name, description, icon, background, role = GetSpecializationInfo(specIndex [, isInspect [, isPet [, ? [, genderCode]]]])
-- in classic:
